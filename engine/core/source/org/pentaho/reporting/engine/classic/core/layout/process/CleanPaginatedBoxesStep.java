...
//      return startTableSectionStyleBox( box );
  ...
  private void removeFinishedNodes( final RenderBox box,
    ...
    DebugReporter.DR.printNode( last, ". removeFinishedNodes last " + last.getClass().getSimpleName());
    DebugReporter.DR.printNode( replacement, ". removeFinishedNodes replacement ", true );
